...
from .models import User, UserProfile, OTP, Role
from .services import RoleService, UserService, OTPService
...
class ForgetPasswordSerializer(serializers.Serializer):
    ...
    def validate_email(self, value):
        if not User.objects.filter(email=value).exists():
            raise CustomAPIException("User with this email does not exist")
        return value
