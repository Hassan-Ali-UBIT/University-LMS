        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Empowering educators with modern tools for seamless learning and attendance management.
            </p>
...
// Icons (You can replace these with actual icons from Lucide or any other library)
